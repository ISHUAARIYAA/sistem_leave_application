  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="medical leave" id="medical leave">
        <label class="form-check-label" for="medical leave">
        medical leave
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="family issues" id="family issues">
        <label class="form-check-label" for="family issues">
        family issues
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="marriage" id="marriage">
        <label class="form-check-label" for="marriage">
        marriage leave
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="prayer leave" id="prayer leave">
        <label class="form-check-label" for="prayer leave">
        prayer leave
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="emergency leave" id="emergency leave">
        <label class="form-check-label" for="emergency leave">
        emergency leave        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="quarantine leave" id="quarantine leave">
        <label class="form-check-label" for="quarantine leave">
        quarantine leave        </label>
      </div>
      <div class="form-check">
