...
error_reporting(E_ALL);
  ...
  <div class="container">
    ...
    <form method="POST" autocomplete="off">
      ...
      <select name="Department">
        <option></option>
        <option>Diploma cadd senibina</option>
        <option>Sijil cadd senibina (Sem 1)</option>
        <option>Sijil cadd senibina (Sem 2)</option>
        <option>Sijil cadd senibina (Sem 3)</option>
        <option>Sijil cadd senibina (Sem 4)</option>
        <option>Diploma computer rangkaian(Sem 5) </option>
        <option>Diploma computer rangkaian(Sem 4) </option>
        <option>Sijil computer rangkaian(Sem 1) </option>
        <option>Sijil computer rangkaian(Sem 2) </option>
        <option>Sijil computer rangkaian(Sem 2) </option>
        <option>diploma multimedia (Sem 5)</option>
        <option>diploma multimedia (Sem 4)</option>
        <option>Sijilmultimedia (Sem 1)</option>
        <option>Sijilmultimedia (Sem 2)</option>
        <option>Sijilmultimedia (Sem 3)</option>
        <option>Sijil aplikasi web</option>
      </select>
      </div>
  ...
  <div>
    <p class="text-center">&copy; <?php echo date("Y"); ?> - Online Leave Application</p>
      <p class="text-center">Developed ishuaariyaa krishnan</p>
    </div>
  </footer>
